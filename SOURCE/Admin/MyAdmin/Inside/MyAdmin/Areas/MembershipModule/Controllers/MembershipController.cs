...
using MyAdmin.Areas.MembershipModule.Models;
...
namespace MyAdmin.Areas.MembershipModule.Controllers
{
    public class MembershipController : BaseController
    {
        ...
        /// <returns></returns>
        /// view popup tạo quyền cho user
        //public ActionResult PopupAdminUserManager(AdminUserModel model)
        //{
        //    var modelResponse = new PopubAdminUserManagerViewModel();

        //    if (model.ID <= 0) return PartialView(model);
        //    var ar = _memberBusiness.GetInfoMemberAdmin(model.ID);
        //    model.UserID = ar.ID;
        //    model.NickName = ar.NickName;
        //    return PartialView(model);
        //}
