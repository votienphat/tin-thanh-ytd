...
using BusinessObject.MembershipModule.Models.Response;
...
namespace BusinessObject.MembershipModule
{
    public class MemberBusiness : IMemberBusiness
    {
        ...
        public Ins_AdminConfigData_getConfigByAdminID_Result AdminConfigData_getConfigByAdminID(int adminId,
            int keyId)
        {
            return _memberAdminRepo.AdminConfigData_getConfigByAdminID(adminId, keyId);
        }
        ...
        {
            return _memberAdminRepo.UpdateAdminConfigData(adminId, keyId, configData, note);
        }
        ...
        {
            return _memberAdminRepo.GetListUserAdmin();
        }
    }
}